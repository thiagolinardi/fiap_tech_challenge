...
{
    public class GetPagedOrdersQueryHandler : MediatorQueryHandler<GetPagedOrdersQuery, PagedResult<OrderDto>>
    {
        ...
        {
            var orders = await _orderRepository.PagedListAsync(request.Pagination);
